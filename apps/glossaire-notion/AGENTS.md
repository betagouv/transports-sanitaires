...
dérogation assumée à la règle du dépôt (voir `../../AGENTS.md § Français`) : elle
n'a pas de vocabulaire métier propre. **N'y mélange pas les deux langues**, du
code neuf ici s'écrit en anglais comme ce qui l'entoure.
