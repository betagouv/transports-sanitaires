// Les trois familles engendrées de la matrice v9.1 : l'exploration exhaustive de
...
// leur séparation d'avec `regression-v9-1.test.ts`.
...
describe("modèle v9.1 — P1-EXHAUSTIVE", () => {
...
describe("modèle v9.1 — générateurs du livrable", () => {
  const CONVOCATIONS = [
