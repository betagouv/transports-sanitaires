...
// la grille (`grille-v9-7-1.test.ts`) balaie un produit croisé.
//
...
// entière : la charge de l'établissement (`article-80-v9-7-1.test.ts`), l'accord
// préalable (`accord-prealable-v9-7-1.test.ts`) et la permission temporaire de
// sortie (`permission-v9-7-1.test.ts`).

import { describe, expect, it } from "vitest";
import { evaluerLeCas, type OptionsDuLivrable } from "./livrable-v9-7-1";
import { DAP, NON_ELIGIBLE, PMT } from "./situations-v9-7-1";
