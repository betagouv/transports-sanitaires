...
//   accompagnent la recopie des contenus dans `orientation-caisse-v9-7-3.test.tsx`.
...
//   `faits-connus.ts` dans `faits-connus-v9-7-3.test.tsx`.
...
describe("RETOURS972 / INDEPENDANT972 — l’attente de l’accord préalable", () => {
  ...
  // `CAISSE-URGENCE-REPONSE-OBLIGATOIRE` dans `convocation-aerienne-v9-7-3.test.ts`.
