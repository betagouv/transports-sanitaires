...
// Matrice de non-régression métier (règles plates v9.4.1). Elle n'a pas de scénarios
...
describe("modèle v9.4.1 — le moteur confirme les attendus des seeds", () => {
...
describe("modèle v9.4.1 — couverture des cas finaux", () => {
...
describe("modèle v9.4.1 — couverture des régimes de financement", () => {
