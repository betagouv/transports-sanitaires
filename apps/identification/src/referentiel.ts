...
// (aujourd'hui un snapshot factice ; demain la micro-fonction Grist puis
// FINESS/RPPS) sans toucher les composants consommateurs.
//
// Incrément 1 : implémentation `snapshotReferentiel` avec des données factices,
// 100 % statique. Aucune PII réelle.
